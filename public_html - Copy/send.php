...
if(isset($_POST["send"])){ 
    ...
    if(isset($_POST['selected_options'])) {
        ...
        // $selectedOptions is an array of selected values
        foreach($selectedOptions as $option) {
            $message .= "<b> ==> ".$option."</b> <br>";
        }
        ...
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <div class=\"info-item\"><span class=\"info-label\">Interested in:</span><br>" .
                        implode("<br>", array_map(function($option) { return "<b> # $option</b>"; }, $_POST['selected_options'])) . "
                    </div>
                    <div class=\"info-item\"><span class=\"info-label\">Subject:</span> {$_POST['subject']}</div>
